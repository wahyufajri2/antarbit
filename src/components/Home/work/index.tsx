  ...
  const services = [
    {
      ...
      text: 'Pengembangan Web dan Aplikasi Mobile',
    },
    {
      icon: '/images/chooseus/chooseus-icon-2.svg',
      text: 'Konsultasi & Strategi TI Anda',
    },
    {
      icon: '/images/chooseus/chooseus-icon-3.svg',
      text: 'Desain & Optimalisasi Basis Data',
    },
    {
      icon: '/images/chooseus/chooseus-icon-3.svg',
      text: 'Integrasi Sistem & Otomatisasi Proses',
    },
  ]
          ...
          <motion.div
            ...
            <div className='flex flex-col gap-3'>
              <p className="text-white font-medium">
                Mengapa memilih <span className='text-primary'>Antarbit?</span>
              </p>
          ...
          <motion.div {...TopAnimation} className='lg:col-span-5 col-span-12'>
            <div className='2xl:-mr-40 mt-9 flex justify-center'>
              <Image
                ...
                src='/images/work/antarbit.png'
                alt='gambar alasan memilih antarbit'
                width={600}
                height={425}
                className='lg:w-full'
              />
