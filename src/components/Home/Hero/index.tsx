          ...
          >
            <div className="flex flex-col gap-4 text-center lg:text-left">
              <div className="flex gap-6 items-center lg:justify-start justify-center">
                ...
                >
                  Antarbit Sinergi Bersama
                </Badge>
              </div>
              <h1 className="font-medium xl:text-[72px] md:text-6xl sm:text-5xl text-4xl text-white">
                Wujudkan Solusi Tepat Sasaran, Khusus untuk Anda
              </h1>
              <p className="text-white">
                Butuh aplikasi atau sistem digital? Antarbit siap nemenin
                perjalanan kamu dari sekadar ide sampai jadi produk matang. Kita
                kerja bareng-bareng, dan hasilnya dijamin terpercaya.
              </p>
            </div>
