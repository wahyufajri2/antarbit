        ...
        <div className="grid grid-cols-1 sm:grid-cols-11 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          <div className="lg:col-span-4 md:col-span-6 col-span-6 flex flex-col gap-6">
            ...
            <p className="text-white/60">
              Mulai dari instansi kementerian sampai teman-teman startup, kami
              bangga bisa ikut andil bikin solusi digital yang pas dan ngebawa
              manfaat nyata buat mereka.
            </p>
            <div className="flex gap-6 items-center relative z-1">
              <Link
                href="https://www.facebook.com/antarbit/"
                className="group"
                target="_blank"
              >
                <Icon
              ...
              <Link
                href="https://www.instagram.com/antarbit/"
                className="group"
                target="_blank"
              >
                <Icon
              ...
              <Link
                href="https://www.twitter.com/antarbit"
                className="group"
                target="_blank"
              >
                <Icon
